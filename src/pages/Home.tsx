  ...
  useEffect(() => {
    const fetchBalances = async () => {
      ...
      try {
        ...
        const walBalanceData = await client.getBalance({ owner: address, coinType: '0x8190b041122eb492bf63cb464476bd68c6b7e570a4079645a8b28732b6197a82::wal::WAL' }).catch(() => null);
    ...
    <div className="chat-container">
      <div className="chat-sidebar">
        ...
        <div>
          ...
          <button onClick={goToVoting} style={{ marginTop: '10px' }} disabled={!currentAccount}>
            Go to voting
          </button>
        </div>
      </div>
